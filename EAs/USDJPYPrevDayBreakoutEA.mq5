...
#property description "USDJPY previous-day breakout continuation EA"
...
input ulong MagicNumber = 26032002;
...
void OnTick()
{
   ...
   if(upTrend && close1 > prevDayHigh && high1 > prevDayHigh)
      OpenPosition(ORDER_TYPE_BUY, atrPrice, "USDJPY prev-day breakout buy");
   else if(downTrend && close1 < prevDayLow && low1 < prevDayLow)
      OpenPosition(ORDER_TYPE_SELL, atrPrice, "USDJPY prev-day breakout sell");
}
